...
+ (Skeleton *)skeletonFromUserGenerator:(xn::UserGenerator)userGenerator user:(XnUserID)user {
    ...
    skeleton.userGenerator = userGenerator;
...
- (XnSkeletonJointPosition)head {
    XnSkeletonJointPosition head = GetJointPosition(self.userGenerator, self.userID, XN_SKEL_HEAD);
    return head;
}

- (XnSkeletonJointPosition)neck {
    XnSkeletonJointPosition neck = GetJointPosition(self.userGenerator, self.userID, XN_SKEL_NECK);
    return neck;
}
